...
sponsor_country <- hybrid_invoice %>%
  # manual changes
  mutate(Country = ifelse(grepl("European|CERN", oa_sponsor_name), "EU", Country)) %>%
...
sponsor_country_t %>%
  count(issued_year, Sector, country_factor, cc_norm) %>%
  ggplot(aes(issued_year, n, fill = Sector)) + 
