...
oa_uptake_15_19 <- hybrid_volume %>% 
  ...
  inner_join(oa_per_jn_year, by = c("issn", "issued_year")) %>%
    ...
    mutate(prop = oa / articles) 
# article volume 2015-19
volume_15_19 <- els_pub_volume %>%
  # elgible journals
  filter(issn %in% eligible_jns$issn) %>%
...
total_df <- tibble::tibble(
  ...
  articles_n = volume_15_19$n,
  articles_mean = volume_15_19$mean_articles,
  articles_sd = volume_15_19$sd,
...
gt_1
#gt::gtsave(gt_1, here::here("figure", "gt_overview.png"), dpi = 300)
```
