...
table_descriptives_ind <- tribble(
  ...
  "of which OA", "oa_n", "Total ",
  "of which OA", "oa_mean", "Avg.",
  "of which OA", "oa_sd", "SD",
  "OA Uptake (in%)", "oa_uptake", "Percentage",
  "OA Uptake (in%)", "oa_uptake_mean", "Avg.",
  "OA Uptake (in%)", "oa_uptake_sd", "SD",
  "Elsevier Hybrid Journals with OA article(s)", "n_journals", "Journals"
)
